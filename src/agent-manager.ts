...
export class AgentManager{
 ...
 async submit(conversation:Conversation,requestId:string,message:string,source:{transport:"matrix"|"signal";eventId:string}):Promise<{response:string;sessionId:string}>{
